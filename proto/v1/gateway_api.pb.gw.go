...
func request_GatewayAPI_Ping_0(ctx context.Context, marshaler runtime.Marshaler, client GatewayAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_GatewayAPI_Ping_0(ctx context.Context, marshaler runtime.Marshaler, server GatewayAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq empty.Empty
	var metadata runtime.ServerMetadata
...
func RegisterGatewayAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GatewayAPIServer) error {
	...
	mux.Handle("GET", pattern_GatewayAPI_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_GatewayAPI_Ping_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_GatewayAPI_Ping_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGatewayAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GatewayAPIClient) error {
	...
	mux.Handle("GET", pattern_GatewayAPI_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_GatewayAPI_Ping_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_GatewayAPI_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "api", "ping"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_GatewayAPI_Ping_0 = runtime.ForwardResponseMessage
)
